...
# cap = cv2.VideoCapture("http://192.168.19.105:8080/video")
...
if not os.path.exists("ip_saved_media10"):
    os.makedirs("ip_saved_media10")
...
while True:
    ...
    if current_time - start_time >= capture_interval:
        ...
        if ret:
            ...
            filename = f"ip_saved_media10/image_{current_time}.jpg"
    ...
    if len(image_frames) >= max_frames_per_video:
        ...
        video_filename = f"ip_saved_media10/video_{current_time}.avi"
